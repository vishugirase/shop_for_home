...
const SortLowToHigh = () => {
    ...
    useEffect(() => {
        ...
        fetch("http://localhost:8082/product/getLowTOHigh")
            .then((res) => {
                return res.json();
            }).then((resp) => {
                console.log(resp);
    ...
    return (
        ...
        <div className='main-div'>
            ...
            <hr></hr>
            <center><h3 style={{ color:'black'}}>PRODUCTS</h3>
            ...
            <Button className='button1'><Link to='/SortHighToLow' className='link1'>Sort High TO Low</Link></Button>
